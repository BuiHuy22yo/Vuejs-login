export const authHeaders = (headers = {}) => {
  const token =
    !!localStorage.getItem('user_login') && JSON.parse(localStorage.getItem('user_login')).token
...
export const isLoggedIn = () => {
  return !!localStorage.getItem('user_login') && !!JSON.parse(localStorage.getItem('user_login')).token
}
//
